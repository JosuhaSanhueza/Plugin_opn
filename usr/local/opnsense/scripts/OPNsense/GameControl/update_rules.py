...
def update_game_control():
    log_msg('Iniciando sincronización 100% AdGuard Home Puro...')
    ...
    for ip_addr in unblocked_ips:
        for domain in domains:
            user_rules.append(f'@@||{domain}^={ip_addr}')
...
'.join(user_rules)
        ...
        log_msg(f'API Auth / Acceso directo a AdGuardHome.yaml...')
...
' + formatted_rules
                    ...
                    log_msg(f'Reglas actualizadas en {yaml_path}. Recargando AdGuard Home...')
