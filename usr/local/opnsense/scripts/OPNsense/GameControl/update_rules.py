...
def generate_unbound_rules():
    ...
    # Asignar etiqueta "gaming_blocked" ÚNICAMENTE a las IPs que están marcadas como bloqueadas
    ...
    # Configurar el bloqueo de dominios exclusivamente para la etiqueta "gaming_blocked"
