...
def update_game_control():
    log_msg("Sincronizando excepciones exlusivas de JUEGOS para AdGuard Home...")
    ...
    # EXCEPCIONES EXCLUSIVAS PARA DOMINIOS DE JUEGOS DE LA LISTA
    # No usamos @@||* (que desbloqueaba todo), sino exenciones especificas por cada juego
    ...
    try:
        ...
        with urllib.request.urlopen(req, timeout=3) as resp:
            rules_written = True
            log_msg("Excepciones exclusivas de juegos sincronizadas via API.")
    except Exception:
        pass
        ...
        for yaml_path in ["/usr/local/bin/AdGuardHome.yaml", "/var/db/adguardhome/AdGuardHome.yaml", "/usr/local/etc/adguardhome/AdGuardHome.yaml", "/var/adguardhome/AdGuardHome.yaml"]:
            if os.path.exists(yaml_path):
                try:
                    ...
                    log_msg("Excepciones exclusivas de juegos escritas en " + yaml_path + ". Recargando AdGuard...")
