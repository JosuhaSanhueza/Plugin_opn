...
def update_game_control():
    log_msg("Sincronizando las 686 exenciones exactas de juegos para AdGuard Home...")
    ...
    try:
        ...
        with urllib.request.urlopen(req, timeout=5) as resp:
            rules_written = True
            log_msg("Excepciones exactas (" + str(len(user_rules)) + " lineas) sincronizadas via API.")
    except Exception:
        pass
        ...
        for yaml_path in ["/usr/local/bin/AdGuardHome.yaml", "/var/db/adguardhome/AdGuardHome.yaml", "/usr/local/etc/adguardhome/AdGuardHome.yaml", "/var/adguardhome/AdGuardHome.yaml"]:
            if os.path.exists(yaml_path):
                try:
                    ...
                    log_msg("Las " + str(len(user_rules)) + " reglas de exencion escritas en " + yaml_path + ". Recargando AdGuard...")
