...
def generate_unbound_rules():
    ...
    # Aplicar la configuración de Unbound
    lines = [
    ...
    # Asignar etiqueta "gaming_blocked" únicamente a las IPs bloqueadas
    ...
    # Para cada dominio de la lista de juegos, definir local-zone transparent global
    # y asignarle la acción de bloqueo (always_refuse / always_null) únicamente cuando la petición venga de la etiqueta "gaming_blocked"
